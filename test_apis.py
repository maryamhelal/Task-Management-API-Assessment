...
# 29. Test update pending tasks to be in progress
def test_put_pending_tasks_returns_success():
    response = client.put("/tasks/updateAll/pending")
    assert response.status_code == 200

# 30. Test delete cancelled tasks
def test_delete_cancelled_tasks_returns_success():
